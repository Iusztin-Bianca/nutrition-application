...
import { getFoods, FoodItem, checkFoodName, uploadFoodImage } from '@/services/foodService';
...
export default function CreateRecipePage() {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => checkFoodName(trimmed).then(setNameExists), 500);
  ...
  // Calculated totals (of the whole recipe)
    ...
    <div className="min-h-screen bg-[#f5f0e5] flex flex-col items-center py-10 px-6 gap-6">
      ...
      {success && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-3xl shadow-xl p-8 w-full max-w-sm flex flex-col items-center gap-4">
            ...
            <h2 className="text-xl font-bold text-gray-900">Rețetă salvată!</h2>
            <p className="text-gray-500 text-sm text-center">Rețeta a fost adăugată cu succes în baza de date.</p>
            <Button
      ...
      <div className="bg-white rounded-3xl shadow-sm p-8 w-full max-w-lg flex flex-col gap-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">Creează rețetă</h1>
            <p className="text-gray-500 text-xs mt-0.5">Nutrienții se calculează automat din ingrediente</p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            placeholder="ex: Salată de ton cu avocado"
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea
            ...
            rows={2}
            placeholder="Mod de preparare, porții, etc."
        ...
        {!canSave && ingredients.length === 0 && name.trim() !== '' && (
          <p className="text-xs text-gray-400 text-center">Adaugă cel puțin un ingredient.</p>
        )}
